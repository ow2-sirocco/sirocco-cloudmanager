...
public interface IMonitoringService {
    List<PerfMetricInfo> getAvailableMachinePerfMetrics(String machineId) throws CloudProviderException;

    List<PerfMetric> getMachinePerfMetrics(final String machineId, final PerfMetricInfo info, final Date startTime,
