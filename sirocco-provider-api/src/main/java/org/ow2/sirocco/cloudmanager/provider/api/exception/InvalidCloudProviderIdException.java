 ...
 */
public class InvalidCloudProviderIdException extends CloudProviderException {
     ...
     * message.
     */
    public InvalidCloudProviderIdException() {
    }
     ...
     */
    public InvalidCloudProviderIdException(final String message) {
        super(message);
    }
