 ...
 *
 */
package org.ow2.sirocco.cloudmanager.provider.api.entity.util;
...
public class SqlTableCreator {
    ...
    public static void main(final String[] args) {
        ...
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.CloudProvider.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.CloudProviderAccount.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.CloudProviderLocation.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.CloudSettings.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.Event.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.Machine.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.MachineAdmin.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.Volume.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.Project.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.User.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.ResourceQuota.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.RoleAssignment.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.MachineImage.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.SystemInstance.class);
        coll.add(org.ow2.sirocco.cloudmanager.provider.api.entity.SystemTemplate.class);
