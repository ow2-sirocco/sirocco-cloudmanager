 ...
 */
public class InvalidCloudProviderAccountException extends CloudProviderException {
     ...
     * message.
     */
    public InvalidCloudProviderAccountException() {
    }
     ...
     */
    public InvalidCloudProviderAccountException(final String message) {
        super(message);
    }
