...
public class Activator implements BundleActivator {
    ...
    public void start(final BundleContext context) {
        ...
        props.put(Constants.SERVICE_PID, "AmazonCloudProviderConnector");
        props.put(ICloudProviderConnector.CLOUD_PROVIDER_TYPE_PROPERTY, "amazon");

        AmazonCloudProviderConnector mockCloudProviderConnector = new AmazonCloudProviderConnector();
