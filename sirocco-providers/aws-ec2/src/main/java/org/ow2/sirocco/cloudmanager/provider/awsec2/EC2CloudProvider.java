...
public class EC2CloudProvider implements ICloudProvider {

    private static Log logger = LogFactory.getLog(EC2CloudProvider.class);
    ...
    private final EC2CloudProviderFactory ec2CloudProviderFactory;

    private IComputeService computeService;

    public EC2CloudProvider(final EC2CloudProviderFactory ec2CloudProviderFactory,
    ...
    public IComputeService getComputeService() throws CloudProviderException {
        if (this.computeService == null) {
            this.computeService = new EC2ComputeService(this.ec2CloudProviderFactory, this.cloudProviderAccount,
