...
public class AvailablePortFinder {
    ...
    public static Set<Integer> getAvailablePorts() {
        return AvailablePortFinder.getAvailablePorts(AvailablePortFinder.MIN_PORT_NUMBER, AvailablePortFinder.MAX_PORT_NUMBER);
    }
    ...
    public static int getNextAvailable() {
        return AvailablePortFinder.getNextAvailable(AvailablePortFinder.MIN_PORT_NUMBER);
    }
    ...
    public static int getNextAvailable(final int fromPort) {
        if (fromPort < AvailablePortFinder.MIN_PORT_NUMBER || fromPort > AvailablePortFinder.MAX_PORT_NUMBER) {
            throw new IllegalArgumentException("Invalid start port: " + fromPort);
        }

        for (int i = fromPort; i <= AvailablePortFinder.MAX_PORT_NUMBER; i++) {
    ...
    public static boolean available(final int port) {
        if (port < AvailablePortFinder.MIN_PORT_NUMBER || port > AvailablePortFinder.MAX_PORT_NUMBER) {
    ...
    public static Set<Integer> getAvailablePorts(final int fromPort, final int toPort) {
        if (fromPort < AvailablePortFinder.MIN_PORT_NUMBER || toPort > AvailablePortFinder.MAX_PORT_NUMBER || fromPort > toPort) {
