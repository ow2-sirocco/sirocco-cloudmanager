...
@XmlType(name = "CIM_ResourceAllocationSettingData_Type", namespace = "http://schemas.dmtf.org/wbem/wscim/1/cim-schema/2/CIM_ResourceAllocationSettingData", propOrder = {
    "address", "addressOnParent", "allocationUnits", "automaticAllocation", "automaticDeallocation", "caption", "connection",
    "consumerVisibility", "description", "elementName", "hostResource", "instanceID", "limit", "mappingBehavior",
    "otherResourceType", "parent", "poolID", "reservation", "resourceSubType", "resourceType", "virtualQuantity",
    "virtualQuantityUnits", "weight", "any"})
...
public class CIMResourceAllocationSettingDataType {
     ...
     * 
     * @return possible object is {@link ResourceAllocationCaption }
     */
     ...
     * 
     * @param value allowed object is {@link ResourceAllocationCaption }
     */
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the hostResource property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
