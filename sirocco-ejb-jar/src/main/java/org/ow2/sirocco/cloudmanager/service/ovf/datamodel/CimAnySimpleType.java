...
@XmlSeeAlso({AutomaticRecoveryAction.class, AutomaticShutdownAction.class, AutomaticStartupAction.class,
    ConsumerVisibility.class, ResourceType.class, MappingBehavior.class})
