...
/**
 * Cloud administration event that indicates that a VM image has been updated.
 */
public class VMImageUpdateEvent extends CloudAdminEvent implements Serializable {
     ...
     */
    public VMImageUpdateEvent(final VMImageVO image) {
        this.image = image;
    }
     ...
     * 
     * @return the VM image that has been created
     */
