 ...
 */
public class VolumeUpdateEvent extends CloudAdminEvent implements Serializable {
     ...
     */
    public VolumeUpdateEvent() {
        super();
    }

    /**
     * Constructs a NewVolumeEvent object with a specific volume object
     * 
     * @param volume value object that has been created
     */
    public VolumeUpdateEvent(final VolumeVO volume) {
        this.volume = volume;
    }
     ...
     * 
     * @return description of volume that has been created
     */
