...
public class TerminateVMClient extends Client {
    @Parameter(names = "-vmId", description = "VM vmId", required = true)
    private String vmId;

    public TerminateVMClient() {
        this.commandName = "sirocco-vm-terminate";
    }

    @Override
    protected void operation(final UserAPI proxy) throws Exception {
        proxy.terminateServer(this.vmId);
    }
    ...
    public static void main(final String[] args) {
        new TerminateVMClient().run(args);
    }
}
