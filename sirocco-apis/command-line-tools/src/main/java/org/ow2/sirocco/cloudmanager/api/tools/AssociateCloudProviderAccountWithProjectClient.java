...
public class AssociateCloudProviderAccountWithProjectClient extends Client {
    ...
    public AssociateCloudProviderAccountWithProjectClient() {
        this.commandName = "sirocco-cloudprovider-account-associate";
    }
    ...
    protected void operation(final UserAPI proxy) throws Exception {
        ...
        proxy.associateCloudProviderAccountWithProject(this.accountId, spec);
    }

    public static void main(final String[] args) {
        new AssociateCloudProviderAccountWithProjectClient().run(args);
    }
}
