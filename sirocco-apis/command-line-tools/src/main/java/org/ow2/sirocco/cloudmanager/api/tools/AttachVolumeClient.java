...
public class AttachVolumeClient extends Client {
    ...
    public AttachVolumeClient() {
        this.commandName = "sirocco-attach-volume";
    }
    ...
    protected void operation(final UserAPI proxy) throws Exception {
        ...
        proxy.attachVolume(this.volumeId, spec);
    }

    public static void main(final String[] args) {
        new AttachVolumeClient().run(args);
    }
