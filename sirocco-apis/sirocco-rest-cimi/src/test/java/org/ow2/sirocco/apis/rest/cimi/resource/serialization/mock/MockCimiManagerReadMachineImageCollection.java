...
/**
 * Mock CimiManagerReadMachineImageCollection.
 */
public class MockCimiManagerReadMachineImageCollection implements CimiManager {
    ...
    public void execute(final CimiRequest request, final CimiResponse response) {
        try {
            response.setCimiData(CimiEntityBuilderHelper.buildCimiMachineImageCollection(request.getHeader()
