...
/**
 * Mock CimiManagerCreateMachineConfiguration.
 */
public class MockCimiManagerCreateMachineConfiguration implements CimiManager {

    /**
     * {@inheritDoc}
     * <p>
     * Build a new MachineConfiguration and compare it with the
     * MachineConfiguration in request.
     * </p>
     * 
    ...
    public void execute(final CimiRequest request, final CimiResponse response) {
        try {
            // Build and compare
            CimiMachineConfiguration cimi = CimiEntityBuilderHelper.buildCimiMachineConfiguration(1);
