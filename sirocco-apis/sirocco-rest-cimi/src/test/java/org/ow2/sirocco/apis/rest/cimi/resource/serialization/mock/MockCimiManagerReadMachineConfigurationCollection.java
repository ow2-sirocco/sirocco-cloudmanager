...
/**
 * Mock CimiManagerReadMachineConfigurationCollection.
 */
public class MockCimiManagerReadMachineConfigurationCollection implements CimiManager {
    ...
    public void execute(final CimiRequest request, final CimiResponse response) {
        try {
            response.setCimiData(CimiEntityBuilderHelper.buildCimiMachineConfigurationCollection(request.getHeader()
