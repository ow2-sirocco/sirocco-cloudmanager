...
/**
 * Manage UPDATE request of CredentialsTemplate.
 */
@Component("CimiManagerUpdateCredentialsTemplate")
public class CimiManagerUpdateCredentialsTemplate extends CimiManagerUpdateAbstract {
    ...
    protected Object callService(final CimiRequest request, final CimiResponse response, final Object dataService)
        ...
        if (true == select.isEmpty()) {
            ...
            this.manager.updateCredentialsTemplateAttributes(request.getId(), select.dispatchAttributesValues(dataService));
        }
        return null;
    }
    ...
    protected Object convertToDataService(final CimiRequest request, final CimiResponse response) throws Exception {
        ...
        CredentialsTemplate service = (CredentialsTemplate) context.getConverter().toService(context, request.getCimiData());
        return service;
    }
