...
public class CimiManagerReadMachineImageCollection {

    public CimiManagerReadMachineImageCollection() {
    }
    ...
    public void execute(CimiRequest request, CimiResponse response) {
        ...
        if (status.equals(Status.OK)) {
            response.setCimiData(getMachineImageCollection());
            // status = 200 OK
    ...
    private CimiMachineImageCollection getMachineImageCollection() {
