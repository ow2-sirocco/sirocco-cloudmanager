...
public class CimiManagerUpdateMachineConfigurationCollection extends CimiManagerUpdateAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        // } else {
        // this.manager.updateMachineConfigurationCollection(select.dispatchAttributesValues(dataService));
        // }
        return null;
    }
    ...
    protected Object convertToDataService(final CimiContext context) throws Exception {
        return context.getRootConverter(ResourceType.MachineConfigurationCollection).toService(context,
