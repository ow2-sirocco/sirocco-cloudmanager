...
public class CimiManagerReadMachineTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiMachineTemplateCollection cimi = (CimiMachineTemplateCollection) context.getRootConverter(
            ResourceType.MachineTemplateCollection).toCimi(context, dataService);
