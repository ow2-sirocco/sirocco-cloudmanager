...
/**
 * Manage DELETE request of CredentialsTemplate.
 */
@Component("CimiManagerDeleteCredentialsTemplate")
public class CimiManagerDeleteCredentialsTemplate extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteCredentialsTemplate(context.getRequest().getIds().getId());
        return null;
    }
