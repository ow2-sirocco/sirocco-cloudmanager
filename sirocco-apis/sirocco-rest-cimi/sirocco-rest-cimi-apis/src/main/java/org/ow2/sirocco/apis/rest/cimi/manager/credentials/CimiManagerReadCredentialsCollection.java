...
/**
 * Manage READ request of Credentials collection.
 */
@Component("CimiManagerReadCredentialsCollection")
public class CimiManagerReadCredentialsCollection extends CimiManagerReadAbstract {
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiCredentialsCollection cimi = (CimiCredentialsCollection) context.convertToCimi(dataService,
