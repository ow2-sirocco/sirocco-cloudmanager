...
/**
 * Manage DELETE request of Credentials.
 */
@Component("CimiManagerDeleteCredentials")
public class CimiManagerDeleteCredentials extends CimiManagerDeleteAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        this.manager.deleteCredentials(context.getRequest().getIds().getId());
        return null;
    }
