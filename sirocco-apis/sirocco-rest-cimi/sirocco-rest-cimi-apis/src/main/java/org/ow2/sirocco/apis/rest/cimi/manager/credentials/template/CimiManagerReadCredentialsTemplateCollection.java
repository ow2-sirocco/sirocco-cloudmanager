...
/**
 * Manage READ request of CredentialsTemplate collection.
 */
@Component("CimiManagerReadCredentialsTemplateCollection")
public class CimiManagerReadCredentialsTemplateCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (true == select.isEmpty()) {
            ...
            if (true == select.isNumericArrayPresent()) {
                ...
                out = this.manager.getCredentialsTemplates(numsArray.get(0).intValue(), numsArray.get(1).intValue(),
                    select.getAttributes());
            } else {
                out = this.manager.getCredentialsTemplates(select.getAttributes(),
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiCredentialsTemplateCollection cimi = (CimiCredentialsTemplateCollection) context.convertToCimi(dataService,
