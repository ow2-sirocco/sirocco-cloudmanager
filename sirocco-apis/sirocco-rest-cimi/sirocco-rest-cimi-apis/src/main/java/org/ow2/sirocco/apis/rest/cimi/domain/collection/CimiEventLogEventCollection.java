...
public class CimiEventLogEventCollection extends CimiCollectionAbstract<CimiEventLogEvent> {
     ...
     */
    @Override
    @XmlElement(name = "EventLogEvent")
    @JsonProperty(value = "eventLogEvents")
    public CimiEventLogEvent[] getArray() {
    ...
    @Override
    @JsonProperty(value = "eventLogEvents")
    public void setArray(final CimiEventLogEvent[] items) {
     ...
     */
    @Override
    public CimiArray<CimiEventLogEvent> newCollection() {
        return new CimiEventLogEventArray();
    }
    ...
    public ExchangeType getExchangeType() {
        return ExchangeType.EventLogEventCollection;
    }
    ...
    @XmlTransient
    @JsonIgnore
    public Class<CimiEventLogEvent> getItemClass() {
        return CimiEventLogEvent.class;
    }

    /**
     * Concrete class of the collection.
     */
    public class CimiEventLogEventArray extends CimiArrayAbstract<CimiEventLogEvent> {

        /** Serial number */
        private static final long serialVersionUID = 1L;

        @Override
        public CimiEventLogEvent[] newEmptyArraySized() {
            return new CimiEventLogEvent[this.size()];
        }
    }
}
