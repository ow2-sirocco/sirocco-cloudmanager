    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        ...
        if (true == select.isEmpty()) {
            ...
            if (true == select.isNumericArrayPresent()) {
                ...
                out = this.manager.getVolumeConfigurations(numsArray.get(0).intValue(), numsArray.get(1).intValue(),
                    select.getAttributes());
            } else {
                out = this.manager.getVolumeConfigurations(select.getAttributes(),
