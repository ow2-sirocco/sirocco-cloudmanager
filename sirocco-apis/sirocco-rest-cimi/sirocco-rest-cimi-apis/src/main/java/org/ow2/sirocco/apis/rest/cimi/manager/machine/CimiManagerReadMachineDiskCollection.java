...
public class CimiManagerReadMachineDiskCollection extends CimiManagerReadAbstract {
    ...
    protected Object callService(final CimiContext context, final Object dataService) throws Exception {
        Object out = null;
        out = this.manager.getMachineDisks(context.getRequest().getIds().getIdParent());
        return out;
    }
    ...
    protected void convertToResponse(final CimiContext context, final Object dataService) throws Exception {
        CimiMachineDiskCollection cimi = (CimiMachineDiskCollection) context.convertToCimi(dataService,
