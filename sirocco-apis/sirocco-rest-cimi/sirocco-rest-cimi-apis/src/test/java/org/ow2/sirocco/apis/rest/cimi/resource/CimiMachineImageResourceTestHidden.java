...
public class CimiMachineImageResourceTestHidden extends JerseyTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(CimiMachineImageResourceTestHidden.class);
    ...
    public final void testGetMachineImage() throws Exception {
        ...
        // JSON : Ok
        CimiMachineImageResourceTestHidden.LOGGER.debug("\n===== GET : {}", "JSON : ok");
        ...
        CimiMachineImageResourceTestHidden.LOGGER.debug("COMPLETE:\n\t{}", clientResponse);
        CimiMachineImageResourceTestHidden.LOGGER.debug("STATUS: {}", clientResponse.getStatus());
        CimiMachineImageResourceTestHidden.LOGGER.debug("ENTITY:\n\t{}", clientResponse.getEntity(String.class));
        CimiMachineImageResourceTestHidden.LOGGER.debug("HEADER:\n\t{}", clientResponse.getHeaders());
    ...
    public final void testGetMachineImageCollection() throws Exception {
        ...
        // JSON
        CimiMachineImageResourceTestHidden.LOGGER.debug("\n===== GET : {} {}", "JSON : ok", Constants.PARAM_CIMI_SELECT
            + "=machineImages[1-10]");
        clientResponse = this.resource().path(ConstantsPath.MACHINE_IMAGE)
            .queryParam(Constants.PARAM_CIMI_SELECT, "machineImages[1-10]")
            .accept(MediaTypeCimi.APPLICATION_CIMI_MACHINEIMAGECOLLECTION_JSON_TYPE)
            .header(Constants.HEADER_CIMI_VERSION, Constants.VERSION_DMTF_CIMI).get(ClientResponse.class);
