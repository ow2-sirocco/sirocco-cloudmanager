...
public class ClientAccess {
    ...
    // private static final String PORT_WEBCONTAINER = "3181";
    //
    // private static final String PORT_CAROL = "3182";
    //
    // private static final String PORT_DB = "3184";
    //
    ...
    // ClientAccess.INITIAL_CONTEXT_FACTORY);
    // env.put(Context.PROVIDER_URL, "rmi://localhost:" + carolPort);
    // final long timeout = System.currentTimeMillis() +
    // ClientAccess.INITIALIZE_TIMEOUT * 1000;
    // while (true) {
    // try {
    // Context context = new InitialContext(env);
    // this.machineManager = (IRemoteMachineManager)
    // context.lookup(IMachineManager.EJB_JNDI_NAME);
    // this.cloudProviderManager = (IRemoteCloudProviderManager)
    // context.lookup(ICloudProviderManager.EJB_JNDI_NAME);
    // this.userManager = (IRemoteUserManager)
    // context.lookup(IUserManager.EJB_JNDI_NAME);
    // this.credManager = (IRemoteCredentialsManager)
    // context.lookup(ICredentialsManager.EJB_JNDI_NAME);
    // this.machineImageManager = (IRemoteMachineImageManager)
    // context.lookup(IMachineImageManager.EJB_JNDI_NAME);
    //
    ...
    // ClientAccess.USER_NAME, "232908Ivry");
    // CloudProvider provider =
    // this.cloudProviderManager.createCloudProvider(ClientAccess.CLOUD_PROVIDER_TYPE,
    // "mock");
    // CloudProviderAccount account =
    // this.cloudProviderManager.createCloudProviderAccount(provider.getId().toString(),
    // ClientAccess.ACCOUNT_LOGIN, ClientAccess.ACCOUNT_CREDENTIALS);
    // this.cloudProviderManager.addCloudProviderAccountToUser(user.getId().toString(),
    ...
    // }
    //
    // private void waitForJobCompletion(final WebResource service, final String
    // idJob) throws Exception {
    ...
    // */
    // response =
    // service.path(this.extractPath(idJob)).accept(MediaType.APPLICATION_XML_TYPE).get(ClientResponse.class);
    ...
    // System.out.println("jobRead.getTargetEntity:" +
    // jobRead.getTargetEntity());
    //
    ...
    // final String description, final int numCpus,
    ...
    // this.buildMachineConfiguration("small",
    ...
    // */
    // response =
    // service.path(ConstantsPath.CLOUDENTRYPOINT_PATH).accept(MediaType.APPLICATION_XML_TYPE)
    // .get(ClientResponse.class);
    // Assert.assertEquals(200, response.getStatus());
    // CimiCloudEntryPoint cloudEntryPoint =
    // response.getEntity(CimiCloudEntryPoint.class);
    //
    ...
    // cloudEntryPoint.getCredentials().getHref());
    // }
    // if (null != cloudEntryPoint.getCredentialsTemplates()) {
    // System.out.println("getCredentialsTemplates: " +
    // cloudEntryPoint.getCredentialsTemplates().getHref());
    // }
    // if (null != cloudEntryPoint.getMachineConfigs()) {
    // System.out.println("getMachineConfigs: " +
    // cloudEntryPoint.getMachineConfigs().getHref());
    // }
    // if (null != cloudEntryPoint.getMachineImages()) {
    // System.out.println("getMachineImages: " +
    // cloudEntryPoint.getMachineImages().getHref());
    // }
    // if (null != cloudEntryPoint.getMachines()) {
    // System.out.println("getMachines: " +
    // cloudEntryPoint.getMachines().getHref());
    // }
    // if (null != cloudEntryPoint.getMachineTemplates()) {
    // System.out.println("getMachineTemplates: " +
    // cloudEntryPoint.getMachineTemplates().getHref());
    // }
    //
    // /*
    ...
    // */
    // response =
    // service.path(this.extractPath(cloudEntryPoint.getMachineImages().getHref()))
    // .accept("application/CIMI-MachineImageCollection+xml").get(ClientResponse.class);
    // Assert.assertEquals(200, response.getStatus());
    // CimiMachineImageCollection machineImagesCollection =
    // response.getEntity(CimiMachineImageCollection.class);
    //
    ...
    // for (CimiMachineImage mImage :
    // machineImagesCollection.getMachineImages()) {
    ...
    // */
    // response =
    // service.path(this.extractPath(machineImagesCollection.getMachineImages()[0].getHref()))
    // .accept("application/CIMI-MachineImage+xml").get(ClientResponse.class);
    // Assert.assertEquals(200, response.getStatus());
    // CimiMachineImage machineImage =
    // response.getEntity(CimiMachineImage.class);
    //
    ...
    // machineImage.getImageLocation().getHref());
    //
    // /*
    // * Retrieve the list of Machine Configurations
    // */
    // response =
    // service.path(this.extractPath(cloudEntryPoint.getMachineConfigs().getHref()))
    ...
    //
    // System.out.println("====== " +
    // CimiEntityType.MachineConfigurationCollection);
    // System.out.println("ID: " + machineConfigsCollection.getId());
    // if (null != machineConfigsCollection.getMachineConfigurations()) {
    // for (CimiMachineConfiguration mConfig :
    // machineConfigsCollection.getMachineConfigurations()) {
    ...
    // */
    // response =
    // service.path(this.extractPath(machineConfigsCollection.getMachineConfigurations()[0].getHref()))
    // .accept("application/CIMI-MachineConfiguration+xml").get(ClientResponse.class);
    // Assert.assertEquals(200, response.getStatus());
    // CimiMachineConfiguration machineConfiguration =
    // response.getEntity(CimiMachineConfiguration.class);
    //
    ...
    // System.out.println("getCpu().getNumberVirtualCpus: " +
    // machineConfiguration.getCpu().getNumberVirtualCpus());
    // System.out.println("getCpu().getFrequency: " +
    // machineConfiguration.getCpu().getFrequency());
    // System.out.println("getCpu().getUnits: " +
    // machineConfiguration.getCpu().getUnits());
    // System.out.println("getMemory().getQuantity: " +
    // machineConfiguration.getMemory().getQuantity());
    // System.out.println("getMemory().getUnit: " +
    // machineConfiguration.getMemory().getUnits());
    // for (CimiDiskConfiguration diskConfig : machineConfiguration.getDisks())
    // {
    // System.out.println("disk.getAttachmentPoint: " +
    // diskConfig.getAttachmentPoint());
    // System.out.println("disk.getCapacity.getQuantity: " +
    // diskConfig.getCapacity().getQuantity());
    // System.out.println("disk.getCapacity.getUnits: " +
    // diskConfig.getCapacity().getUnits());
    ...
    // */
    // CimiCredentialsTemplate credentialsTemplate = new
    // CimiCredentialsTemplate();
    ...
    //
    // response =
    // service.path(ConstantsPath.CREDENTIALS_PATH).accept(MediaType.APPLICATION_XML_TYPE)
    // .entity(credentialsCreate,
    ...
    // System.out.println("credentials.getUserNam: " +
    // credentials.getUserName());
    // System.out.println("credentials.getPassword: " +
    // credentials.getPassword());
    // System.out.println("credentials.getCreated: " +
    ...
    //
    // response =
    // service.path(ConstantsPath.MACHINE_PATH).accept(MediaType.APPLICATION_XML_TYPE)
    // .entity(machineCreate,
    // MediaType.APPLICATION_XML_TYPE).post(ClientResponse.class);
    ...
    // System.out.println("jobMachineCreate.Status:" +
    // jobMachineCreate.getStatus());
    // System.out.println("jobMachineCreate.TargetEntity:" +
    // jobMachineCreate.getTargetEntity());
    //
    // /*
    ...
    // */
    // response =
    // service.path(this.extractPath(jobMachineCreate.getTargetEntity())).accept(MediaType.APPLICATION_XML_TYPE)
    // .get(ClientResponse.class);
    // Assert.assertEquals(200, response.getStatus());
    ...
    // System.out.println("getCpu().getNumberVirtualCpus: " +
    // machine.getCpu().getNumberVirtualCpus());
    // System.out.println("getCpu().getFrequency: " +
    // machine.getCpu().getFrequency());
    // System.out.println("getCpu().getUnits: " + machine.getCpu().getUnits());
    // System.out.println("getMemory().getQuantity: " +
    // machine.getMemory().getQuantity());
    // System.out.println("getMemory().getUnit: " +
    // machine.getMemory().getUnits());
    // if (null != machine.getDisks()) {
    // for (CimiDisk disk : machine.getDisks()) {
    // System.out.println("disk.getCapacity.getQuantity: " +
    // disk.getCapacity().getQuantity());
    // System.out.println("disk.getCapacity.getUnits: " +
    // disk.getCapacity().getUnits());
    // }
    // }
    // for (CimiOperation operation : machine.getOperations()) {
    // System.out.println("operation: " + operation.getRel() + ", " +
    // operation.getHref());
    // }
    //
    // /*
    ...
    // response =
    // service.path(this.extractPath(machine.getId())).accept(MediaType.APPLICATION_XML_TYPE)
    // .entity(actionStart,
    // MediaType.APPLICATION_XML_TYPE).post(ClientResponse.class);
    // Assert.assertEquals(202, response.getStatus());
    ...
    // response =
    // service.path(this.extractPath(machine.getId())).queryParam(Constants.PARAM_CIMI_SELECT,
    // "name")
    // .queryParam(Constants.PARAM_CIMI_SELECT,
    // "description").accept(MediaType.APPLICATION_XML_TYPE)
    // .entity(machineToUpdate,
    // MediaType.APPLICATION_XML_TYPE).put(ClientResponse.class);
    // Assert.assertEquals(202, response.getStatus());
