...
@Stateless
@Local
@EJB(name = "java:global/delegate/MachineGetPlacement", mappedName = "MachineGetPlacement", beanInterface = JavaDelegate.class)
public class MachineGetPlacement implements JavaDelegate {
    ...
    public void execute(final DelegateExecution execution) throws Exception {
        try {
            ...
            ICloudProviderResource resource = this.em.find(Machine.class, Integer.valueOf(input_objectId));
