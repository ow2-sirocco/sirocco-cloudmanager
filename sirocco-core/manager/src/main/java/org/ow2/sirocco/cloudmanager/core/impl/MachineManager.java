...
public class MachineManager implements IMachineManager {
    ...
    private MachineVolume getMachineVolume(final List<MachineVolume> list, final Volume v) {
        for (MachineVolume mv : list) {
            if (mv.getVolume().getId().equals(v.getId())) {
                return mv;
            }
     ...
     */
    private boolean completeDeviceAttachmentToMachine(final boolean creation, final Job notification, final Machine local,
        ...
        if (notification.getProperties().containsKey("parent-machine")) {
            ...
            if (op.equals("delete")) {
                ...
                if (children.size() != 0) {
                    ...
                    return this.completeDeviceAttachmentToMachine(false, notification, mpersisted, updated);
                }
            ...
            if (affected == null || affected.size() == 0) {
                ...
                return this.completeDeviceAttachmentToMachine(true, notification, mpersisted, updated);
            }
        }
    ...
    public List<MachineDisk> getMachineDisks(final String machineId) throws ResourceNotFoundException, CloudProviderException,
        ...
        MachineDiskCollection diskColl = m.getDisks();
        if (diskColl.getItems() != null) {
            diskColl.getItems().size();
        }
        return diskColl.getItems();
    }
    ...
    @Override
    public Job addNetworkInterfaceToMachine(final String machineId, final NetworkInterfaceMachine nic)
        throws ResourceNotFoundException, CloudProviderException, InvalidRequestException {
        // TODO Auto-generated method stub
        throw new ServiceUnavailableException(" Operation not permitted ");
    }
    ...
    @Override
    public List<NetworkInterfaceMachine> getMachineNetworkInterfaces(final String machineId) throws ResourceNotFoundException,
        CloudProviderException, InvalidRequestException {
        // TODO Auto-generated method stub
        return null;
    }
