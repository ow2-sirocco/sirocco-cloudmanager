...
public interface IMeterManager {
    ...
    static final String EJB_JNDI_NAME = "org.ow2.sirocco.cloudmanager.core.impl.MeterManager_org.ow2.sirocco.cloudmanager.core.api.IRemoteMeterManager@Remote";
    ...
    MeterConfiguration getMeterConfiguration(final String meterConfigId) throws CloudProviderException, ResourceNotFoundException;
    ...
    void updateMeterConfiguration(final String meterConfigId, Map<String, Object> attributes) throws CloudProviderException, InvalidRequestException, ResourceNotFoundException;
    ...
    void deleteMeterTemplate(String meterTemplateId) throws ResourceNotFoundException,
    ...
    void updateMeter(String meterId, Map<String, Object> attributes) throws ResourceNotFoundException,
    ...
    List<MeterSample> getMeterSamples(String cloudResourceId, String meterId) throws CloudProviderException, ResourceNotFoundException;
